...
class CategoryScreen extends StatefulWidget {
  ...
  @override
  State<CategoryScreen> createState() => _SearchScreenState();
}

class _SearchScreenState extends State<CategoryScreen> {
  List<dynamic> events = [];
  bool loading = true;
  ...
  void fetchSearchData(String q) async {
    try {
      ...
      final data = await EventsService().getCategory(widget.category);
      print(data);
